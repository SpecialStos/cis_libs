...
-- Function was directly copied by ox_lib for maximum compatibility. All credits to the original authors (https://github.com/overextended/ox_lib)
...
function GetPlayerVehicleSeat()
    ...
    if vehicle == 0 then
        return nil  -- Player is not in a vehicle
    end
    ...
    return nil  -- This should never happen if the player is truly in the vehicle
end
